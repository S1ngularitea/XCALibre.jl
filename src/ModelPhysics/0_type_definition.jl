...
- `wall_info`  -- Wall boundary names for turbulence models requiring wall distance. Auto-generated by the `Physics` constructor
...
time, fluid=nothing, solid=nothing, turbulence=nothing, energy, domain, momentum=EFM
    ...
    if turbulence !== nothing
        wall_info = hasproperty(turbulence.args, :walls) ? turbulence.args.walls : nothing
